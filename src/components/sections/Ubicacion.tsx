        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-crema rounded-2xl p-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-oliva/10 flex items-center justify-center shrink-0">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-negro/70">
                    ...
                    <br />
                    <span className="text-sm text-negro/50">
                      Check-in flexible con aviso previo
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-negro/70 text-sm leading-relaxed">
                    • Desde Capital: Acceso Norte, Ruta 8, salida José C. Paz
                    <br />
                    • Desde Zona Norte: Av. Constituyentes hasta Ruta 8<br />• Coordenadas GPS
          ...
          <div className="relative">
            ...
            <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
              <span className="text-sm font-medium text-negro">📍 José C. Paz, Buenos Aires</span>
            </div>
          </div>
        </div>
      </div>
