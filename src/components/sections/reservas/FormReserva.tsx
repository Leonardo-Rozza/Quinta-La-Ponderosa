// ═══════════════════════════════════════════════════════════════════════════════
// FormReserva.tsx - Formulario de datos del cliente
// ═══════════════════════════════════════════════════════════════════════════════
'use client';
...
const esquemaReserva = z.object({
  ...
  comentarios: z.string().max(500, 'Los comentarios son muy largos').optional(),
});
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="form-group">
        ...
        >
          {Array.from({ length: PRECIOS.maximoPersonas }, (_, i) => i + 1).map((num) => (
      ...
      <div className="form-group">
        ...
        />
        {errors.comentarios && <span className="form-error">{errors.comentarios.message}</span>}
      </div>

      <button type="submit" disabled={isLoading} className="btn-mercadopago w-full">
        {isLoading ? (
          <>
