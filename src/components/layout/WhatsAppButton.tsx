      ...
      {showTooltip && isVisible && (
        <div className="whatsapp-tooltip">
          <button
            ...
            className="absolute -top-2 -right-2 w-5 h-5 bg-negro rounded-full flex items-center justify-center text-white"
            aria-label="Cerrar"
          >
            <X className="w-3 h-3" />
          </button>
          <p className="text-sm font-medium text-negro">¿Tenés dudas?</p>
          <p className="text-xs text-negro/60">Escribinos por WhatsApp</p>
        </div>
      )}
    </>
  );
