...
import { NAV_LINKS, CONFIG } from "@/lib/constants";
    ...
    <>
      ...
      >
        <div className="section-container flex justify-between items-center h-16 md:h-20">
              ...
              <li key={link.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    !isScrolled ? "text-white/90 hover:text-white" : "text-negro/80 hover:text-negro"
                  )}
                >
                  {link.label}
                </Link>
          ...
          {/* Botón CTA desktop */}
          <Link href="#reservas" className={cn("hidden md:inline-flex btn-oliva py-2.5 px-5")}>
            Reservar Ahora
          </Link>
      ...
      >
        <div className="flex flex-col items-center justify-center h-full px-4">
          ...
          >
            <Link href="#reservas" onClick={handleLinkClick} className="btn-primary">
              Reservar Ahora
            </Link>
          </div>
          ...
          >
            ...
            <a href={`tel:${CONFIG.telefono}`} className="text-terracota font-medium hover:underline">
